    ...
    <div>
      ...
      <section className="card" style={{ marginTop: '24px' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px', fontFamily: 'monospace', fontSize: '12px', overflowX: 'auto' }}>
          ...
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>name: devopslab-frontend</div>
          <div style={{ color: '#fbbf24' }}>spec:</div>
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>replicas: 3</div>
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>selector:</div>
          <div style={{ color: '#fbbf24', marginLeft: '32px' }}>matchLabels:</div>
          <div style={{ color: '#fbbf24', marginLeft: '48px' }}>app: devopslab-frontend</div>
          <br />
          ...
          <div style={{ color: '#fbbf24' }}>metadata:</div>
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>name: frontend-service</div>
          <div style={{ color: '#fbbf24' }}>spec:</div>
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>type: LoadBalancer</div>
          <div style={{ color: '#fbbf24', marginLeft: '16px' }}>ports:</div>
          <div style={{ color: '#fbbf24', marginLeft: '32px' }}>- port: 80</div>
          <div style={{ color: '#fbbf24', marginLeft: '32px' }}>targetPort: 3000</div>
        </div>
      </section>
      ...
      <section className="card" style={{ marginTop: '24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Deploy Application</h4>
          ...
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Check Status</h4>
            <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#22c55e' }}>
          ...
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Port Forward</h4>
            <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#22c55e' }}>
      ...
      {/* Environment Setup */}
      <section className="card" style={{ marginTop: '24px' }}>
        <h3 style={{ fontSize: '20px', marginBottom: '16px' }}>Environment Setup</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Minikube</h4>
            <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#22c55e' }}>
              minikube start<br />
              minikube dashboard
            </div>
          ...
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Kind</h4>
            <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#22c55e' }}>
          ...
          <div style={{ background: 'rgba(0,0,0,0.3)', padding: '16px', borderRadius: '8px' }}>
            <h4 style={{ fontSize: '14px', marginBottom: '8px', color: '#fbbf24' }}>Docker Desktop</h4>
            <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#22c55e' }}>
