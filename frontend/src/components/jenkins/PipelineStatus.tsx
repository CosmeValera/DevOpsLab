...
// API Configuration
// const API_BASE_URL = 'http://localhost:3001/api/pipelines/status'; // Local
// const API_BASE_URL = 'https://rr5g4eiwfmwb2qcjkig54zd6vy0tnttv.lambda-url.eu-central-1.on.aws/'; // Cloud
...
const PipelineStatus: React.FC = () => {
  ...
  const getPipelineErrorMessage = (pipeline: PipelineStatus) => {
    ...
    switch (pipeline.errorType) {
      ...
      case 'auth_invalid':
        return 'Invalid Jenkins credentials. Please check your username and token. Hint: Configure Backend Authentication which corresponds to step 5 of the Jenkins Configuration and then reload the backend server.';
