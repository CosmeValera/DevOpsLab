    ...
    <div>
      <section className="card">
        ...
        <p className="common-p-small">
          Kubernetes runs containers at scale. Start with three core pieces:
      ...
      <section className="card" style={{ marginTop: "16px" }}>
        ...
        <ul className="common-ul">
          <li>
            <strong>Pod</strong>: the smallest deployable unit. Usually 1
            container; sometimes multiple tightly-coupled containers.
          </li>
          <li>
            <strong>Deployment</strong>: manages a ReplicaSet to keep a desired
            number of identical Pods running; enables rolling updates and
            rollbacks.
          </li>
          <li>
            <strong>Service</strong>: stable virtual IP that routes traffic to
            Pods. Types: ClusterIP, NodePort, LoadBalancer.
          </li>
        </ul>
      </section>
