  ...
  return (
    <div>
      ...
      <section className="card" style={{ marginTop: "16px" }}>
        ...
        <p className="common-p-small">
          An image is a read-only template built from a Dockerfile. A container
          is a lightweight, isolated runtime created from that image. You can
      ...
      <section className="card" style={{ marginTop: "16px" }}>
        ...
        <p className="common-p-small">
          A Dockerfile describes how to build an image: base image, files to
          copy, commands to run and the process to start. Typical instructions:
