  ...
  return (
    <div>
      <div style={{ textAlign: "center", marginBottom: "32px" }}>
        ...
        <p className="common-p">Learn the technologies step by step</p>
      </div>
      ...
      <div
        ...
        <div
          ...
          style={{ borderLeft: "6px solid var(--accent-purple)" }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
        ...
        <div
          className="card tutorial-card"
          style={{ borderLeft: "6px solid var(--accent-yellow)" }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
        ...
        <div
          className="card tutorial-card"
          style={{ borderLeft: "6px solid var(--accent-red)" }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
        ...
        <div
          className="card tutorial-card"
          style={{ borderLeft: "6px solid var(--accent-green)" }}>
          <div
            style={{
              display: "flex",
              justifyContent: "space-between",
            ...
            <div
              ...
              <span
                style={{
                  background:
                    "linear-gradient(90deg, #22a73b 60%, #4ade80 100%)",
                  color: "#fff",
                  padding: "4px 12px",
                  borderRadius: "12px",
                  fontSize: "12px",
