    ...
    <div className="home">
      ...
      <div className="home__hero">
        ...
        <p className="home__subtitle">
          Explore different methods to deploy this application, learn through hands-on tutorials, and discover CI/CD automation with industry-standard DevOps tools. Powered by AWS.
        </p>
      </div>
